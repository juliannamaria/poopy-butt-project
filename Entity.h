...
class Entity
{
    ...
    Entity(string name, double hp, int gold, char condition, char type, double stamina, double defense, bool advantage, char elemental_weakness, string starting_items, int num_items);
